...
try:
    ...
    warmup_bars = max(13, bb_window) * 5  # 지표 안정화용 워밍업
    ...
    # ✅ 현재가 보정 (마지막 봉 close 업데이트) — 화면 줌/스크롤은 uirevision으로 유지
    try:
    ...
    fig.update_layout(
        ...
        uirevision="constant"  # ✅ 줌/스크롤 상태 유지
    )
